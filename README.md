...
2. Setup a conda environment (or something similar) with OpenCV 4.4.0 - Important that the version of OpenCV is not newer, multiple object tracking was deprecated in later versions
